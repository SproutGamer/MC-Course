...
object ModItemGroups {
    val FLUORITE_GROUP = registerItemGroup(
        "fluorite", FabricItemGroup.builder()
    ...
    private fun registerItemGroup(name: String, itemGroup: ItemGroup): ItemGroup {
        return Registry.register(Registries.ITEM_GROUP, Identifier.of(MCCourse.ID, name), itemGroup)
    }
