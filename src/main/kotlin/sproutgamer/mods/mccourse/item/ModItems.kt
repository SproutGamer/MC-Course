...
object ModItems {
    ...
    val STRAWBERRY = registerItem("strawberry", { settings ->
    ...
    val METAL_DETECTOR = registerItem("metal_detector", ::MetalDetectorItem, Item.Settings().maxDamage(200))
    val DATA_TABLET = registerItem("data_tablet", ::DataTabletItem, Item.Settings().maxCount(1))

    val FLUORITE_SWORD = registerItem(
        "fluorite_sword", { settings ->
            ModEffectSwordItem(
                ModToolMaterial.FLUORITE, 8f, -2.4f, settings,
    ...
    val FLUORITE_HELMET = registerItem(
        "fluorite_helmet", { settings -> ModArmorItem(ModArmorMaterials.FLUORITE, EquipmentType.HELMET, settings) },
        Item.Settings()
    )
    val FLUORITE_CHESTPLATE = registerItem(
        "fluorite_chestplate",
        { settings -> ModArmorItem(ModArmorMaterials.FLUORITE, EquipmentType.CHESTPLATE, settings) },
        Item.Settings()
    )
    val FLUORITE_LEGGINGS = registerItem(
        "fluorite_leggings", { settings -> ModArmorItem(ModArmorMaterials.FLUORITE, EquipmentType.LEGGINGS, settings) },
        Item.Settings()
    )
    val FLUORITE_BOOTS = registerItem(
        "fluorite_boots", { settings -> ModArmorItem(ModArmorMaterials.FLUORITE, EquipmentType.BOOTS, settings) },
        Item.Settings()
    )

    val FLUORITE_HORSE_ARMOR = registerItem(
        "fluorite_horse_armor",
        { settings -> AnimalArmorItem(ModArmorMaterials.FLUORITE, AnimalArmorItem.Type.EQUESTRIAN, settings) },
        Item.Settings()
    )
